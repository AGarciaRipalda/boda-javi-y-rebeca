  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center px-4">
        ...
        <div className="mt-auto flex w-full flex-col items-center pb-14 -translate-y-7">
          <motion.div
            variants={fadeUp}
          ...
          >
            ...
            <div className="mt-2 font-serif text-base sm:text-lg text-foreground/80 leading-relaxed">
              {addressLines.map((line) => (
                <p key={line}>{line}</p>
              ))}
            </div>
            <p className="mt-1 font-serif text-base sm:text-lg text-foreground/80">
            {time}
            </p>
          </motion.div>
          ...
          {mapUrl ? (
            <motion.a
              ...
              className="mt-18 flex flex-col items-center gap-2 group"
            >
